            ...
            <div id="content">
                <section>
                    <div class="section-body">
                        @foreach($preferred_area_groups as $preferred_area_group)
                            <div class="row">
                                <!-- START HEADER XS BOX -->
                                <div class="col-lg-12">
                                    <div class="box">
                                        <div class="box-head box-head-xs style-primary">
                                            <header><h5 class="text-light"> <strong>{{ $preferred_area_group->name }}</strong></h5></header>
                                        </div>
                                        <div class="box-body">
                                            {!! Form::open(['class' => 'form-horizontal']) !!}
                                                <div class="form-group">
                                                    @foreach($preferred_area_group->preferredAreas as $preferred_area)
                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                            <label class="checkbox-inline">
                                                                <input type="checkbox" value="{{ $preferred_area->name }}"> {{ $preferred_area->name }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="box style-transparent">
                                    <div class="box-body text-center">
                                        <p class="text-right">
                                            <button type="button" class="btn btn-primary">선호지역 등록하기</button>
                                        </p>
                                    </div><!--end .box-body -->
                                </div><!--end .box -->
                            </div><!--end .col-lg-12 -->
                ...
                var Curriculum = function() {
                    ...
                    $(document).ready(function() {
                        $(":button").click(function(e) {
                            ...
                            window.opener.$("#preferred_area").val(result);
                            window.close();
                        });
                    });

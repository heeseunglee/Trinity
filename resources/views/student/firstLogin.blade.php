            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            {!! Form::open(array('action' => 'Student\FirstLoginController@update',
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        <label class="control-label" for="position">직급</label>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3">
                                        <label class="control-label" for="deputy">부서</label>
                                    </div>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="deputy" id="deputy" required="" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-3">

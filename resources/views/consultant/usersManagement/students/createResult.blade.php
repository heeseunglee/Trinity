...
@section('main_content')
    <section>
        ...
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> 학생 등록 결과</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="box">
                        <div class="box-head box-head-xs style-primary">
                            <header><h5 class="text-light"> <strong>학생</strong> 등록 결과</h5></header>
                            <div class="tools">
                            ...
                            <table class="table table-condensed table-hover no-margin">
                                ...
                                <tbody>
                                    ...
                                    @foreach($result_array as $key => $result)
                                        <?php $student = \App\Student::find($key); ?>
